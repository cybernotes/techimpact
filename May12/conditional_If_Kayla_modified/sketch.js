...
var recX2 = 300; // creates variable for the x coordinate for second rectangle
var recY2 = 50; // creates variable for the y coordinate for second rectangle
var recStroke = 35; // creates variable for the color for the rectangle's stroke
var recCol; // creates variable for the color of the rectangle while also assigning it's color
recCol = 63, 255, 51; // assigns rgb value to rectangle color 
...
var speed = 2; // creates variable for the speed of the object
...
function draw() {
  ...
  stroke(recStroke); // sets the color of the stroke/outline of the second rectangle
  fill(recCol); // sets the color of the  second rectangle
  rect(recX2, recY2, recSize, recSize); // creates the second rectangle using the x, y, and size variables 

  recY2 = recY2 + speed // sets the speed of the circle by subtracting the speed variable from the second rectangle's y coordinate
