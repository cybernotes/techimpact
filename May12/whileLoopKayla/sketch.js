...
function draw() {
  ...
  var y = 0;// creates a variable for y
  while (y <= height){// if y is less than or equal to the height of the canvas
    stroke(0);// sets the color of the outline 
    fill(255);// sets the color of the rectangle
    rect(200, y, 50, 50);// creates the rectangle with the y coordinate set to variable y
    y = y + 50;// adds 50 to the y coordinate so when looping it adds 50 over and over
  }
